...
function Colors() {
    const colors = [
        { id: 'blue', name: 'Titânio Azul', image: '/imgs/iphone-blue.jpg', colorClass: 'bg-blue-500' },
        { id: 'silver', name: 'Titânio Natural', image: '/imgs/iphone-silver.jpg', colorClass: 'bg-gray-300' },
        { id: 'orange', name: 'Titânio Laranja', image: '/imgs/iphone-orange.jpg', colorClass: 'bg-orange-500' }
    ];

    const models = [
        { name: 'Pro Max', screen: '6.9 polegadas', storage: '256GB, 512GB, 1TB', battery: '33h de vídeo', weight: '221g' },
        { name: 'Pro', screen: '6.3 polegadas', storage: '128GB, 256GB, 512GB', battery: '29h de vídeo', weight: '199g'}
    ];
        ...
        <section id="cores" className="bg-black py-20 px-8">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="text-center mt-16">
                    <button className="bg-blue-700 hover:bg-blue-800 text-white px-12 py-4 rounded-full text-lg font-medium transition-all duration-300 mb-8 hover:scale-105 shadow-md shadow-blue-500/50 cursor-pointer">Compre agora á partir de R$ 9.299,00</button>
                    <p>Ou até em 12x de R$ 994,92 sem juros</p>
                </div>
            </div>
        </section>
    )
