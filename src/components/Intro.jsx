    ...
    return(
        <section className="bg-black py-20 px-6">
            ...
            <div className="flex flex-col md:flex-row gap-4 justify-center items-center mb-16">
                <button className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-4 font-medium text-lg transition-all duration-300 hover:scale-105 shadow-lg shadow-blue-500/50 rounded-full cursor-pointer">Compre agora</button>
